            ...
            <div className="grid place-items-center font-spartan">
                <div className="w-full max-w-[1440px] flex flex-col lg:flex-row lg:h-[534px]">
                    ...
                    <div className='h-[360px] relative'>    
                        ...
                        <img src={heroone} className='absolute lg:hidden w-full h-full object-cover' alt="hero-1" />
                        <img src={hero1d} className='hidden lg:block w-full h-[534px] object-cover ' alt="desktop-img" />
