            ...
            <div className="grid place-items-center font-spartan">
                <div className="w-full max-w-[1440px] flex flex-col">
                    ...
                    <div className='h-[360px] relative'>    
                        ...
                        <div className='absolute right-0 bottom-0 z-5 bg-black flex items-center'>
                            <button type="button" className='flex items-center justify-center w-[56px] h-[55px]'><img src={arrowleft} className='w-[10px]' alt="left-arrow-icon" /></button>
                            <button type="button" className='flex items-center justify-center w-[56px] h-[55px]'><img src={arrowright} className='w-[10px]' alt="right-arrow-icon" /></button>
                        </div>
                    </div>

                    
                    <div className='p-8 flex flex-col items-start gap-8 mt-7'>
                        <div className='flex flex-col gap-4 leading-[1.3]'>
                            <div className='font-semibold tracking-tighter text-[2.55rem] leading-[.9]'>Discover innovative ways to decorate</div>
