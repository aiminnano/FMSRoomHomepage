    ...
    return (
        ...
        <div className="grid place-items-center font-spartan">
            <div className="w-full max-w-[1440px] flex flex-col lg:flex-row">
                <div className='h-[237.5px] lg:h-[266px] w-full max-w-[420px]'><img src={dark} className='h-full w-full object-cover lg:max-w-[420px]' alt="dark-room-img" /></div>
                ...
                <div className='h-[237.5px] lg:h-[266px] w-full max-w-[420px]'><img src={light} className='h-full w-full object-cover ' alt="light-room-img" /></div>
            </div>
        </div>
        </>
    )
